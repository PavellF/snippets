	...
	window.onload = function (){
		...
		document.querySelector("#answerButton").onclick = function(){
			...
			var answer = mathService.getAnswer(parseDisplayElementsArray(),getMeasurement());
			
			alert.innerHTML = "";
			if(isNaN(answer)){
				alert.innerHTML = "Given expression does not correct. Please try again.";
				return;
			}
			
			printAnswerAndAddEntryToHistory(""+answer);
