...
<head>
   ...
   <script src="<s:url value='/resources/MathService.js' />"></script>
   <script src="<s:url value='/resources/app.js' />" type="text/javascript"></script>
</head>
<body>
<div class="container">
		<sec:authorize access="hasAuthority( 'root' )">
              	<form  method="GET" action="<s:url value='/stsocsc' />">
  					<input type="submit"  type="button" value="go to server side computing">
				</form>
        </sec:authorize>
        <div class="row">
