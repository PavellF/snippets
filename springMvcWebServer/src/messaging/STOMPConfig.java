...
public class STOMPConfig extends AbstractWebSocketMessageBrokerConfigurer{
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		registry.addEndpoint("/messaging/main").withSockJS();
	}
	
	@Override
	public void configureMessageBroker(MessageBrokerRegistry registry) {
		registry.enableStompBrokerRelay("/topic", "/queue")
		.setSystemHeartbeatReceiveInterval(Properties.get().getInt("USER_HEARTBEAT_RECEIVE_INTERVAL"))
		.setSystemHeartbeatSendInterval(Properties.get().getInt("USER_HEARTBEAT_SEND_INTERVAL"))
